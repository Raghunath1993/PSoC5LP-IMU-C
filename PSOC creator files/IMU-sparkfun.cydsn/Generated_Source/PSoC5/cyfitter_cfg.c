...
#define BS_UDB_1_1_0_CONFIG_VAL ((const uint8 CYFAR *)0x4800030Cu)
...
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x480003A0u)

/* IOPINS0_3 Address: CYREG_PRT3_DR Size (bytes): 10 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x480003A8u)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x480003C0u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT3_AG, 0x49u);
