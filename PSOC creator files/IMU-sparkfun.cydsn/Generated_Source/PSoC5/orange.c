...
*
* \funcusage
*  \snippet orange_SUT.c usage_orange_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet orange_SUT.c usage_orange_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet orange_SUT.c usage_orange_Read  
*******************************************************************************/
...
* preferred orange_Read() API because the 
* orange_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet orange_SUT.c usage_orange_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: orange_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use orange_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - orange_0_INTR       (First pin in the list)
    *  - orange_1_INTR       (Second pin in the list)
    *  - ...
    *  - orange_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet orange_SUT.c usage_orange_SetInterruptMode
    *******************************************************************************/
    void orange_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & orange_0_INTR) != 0u) 
		{ 
			 orange_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet orange_SUT.c usage_orange_ClearInterrupt
    *******************************************************************************/
